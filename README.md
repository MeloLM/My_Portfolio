...
| 🧪 **225 test** | Vitest + Testing Library su data layer, hook, primitive UI e sezioni. La suite è validata con test di mutazione |
...
npx vitest run      # 17 file, 225 test
