...
[**🌐 Sito**](https://my-portfolio-vert-ten-56.vercel.app) · [**💼 LinkedIn**](https://www.linkedin.com/in/carmelo-la-mantia-web-developer/) · [**✉️ Email**](mailto:carmelo.la.mantia00@gmail.com)
...
| 🧪 **226 test** | Vitest + Testing Library su data layer, hook, primitive UI e sezioni. La suite è validata con test di mutazione |
...
│   ├── privacy/                # Informativa GDPR (statica, zero JS)
...
npx vitest run      # 17 file, 226 test
npx next build      # 16 pagine generate a build time
```
